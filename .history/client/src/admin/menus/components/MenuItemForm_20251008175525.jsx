...
export default function MenuItemForm({
  ...
  const [menuType, setMenuType] = useState(
    data.menu?.type || data.menuType || "weekly"
  );
  ...
  async function handleSubmit(e) {
    ...
    if (!menuType) return setError("Menu Type is required.");

    const payload = {
      id: data.id,
      name: name.trim(),
      description: description.trim() || null,
      imageUrl: imageUrl || null, // relative '/uploads/..' or absolute
      categoryId: categoryId === "" ? null : Number(categoryId),
      menuType, // 'weekly' | 'everyday' | 'special'
    };
