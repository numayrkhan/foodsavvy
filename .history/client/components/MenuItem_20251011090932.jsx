...
export default function MenuItem({ item, serviceDate, serviceLabel }) {
  ...
  // Weekday-only label (e.g., "Mon", "Tue"); we’ll display "Scheduled for Mon"
const scheduleDay = serviceLabel ? serviceLabel.split(" ")[0] : null;
  ...
  return (
    <div className="bg-gray-800 rounded-2xl shadow-md p-6 flex flex-col space-y-4">
      <div className="relative w-full rounded-lg overflow-hidden bg-white/10" style={{ aspectRatio: "4 / 3" }}>
