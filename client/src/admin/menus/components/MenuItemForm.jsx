...
export default function MenuItemForm({
  ...
  const [capacityPerDay, setCapacityPerDay] = useState(
    typeof data.capacityPerDay === "number" ? String(data.capacityPerDay) : ""
  );
  ...
  async function handleSubmit(e) {
    ...
    const payload = {
      ...
      capacityPerDay: capacityPerDay === "" ? null : Number(capacityPerDay),
      weekday,
      weekOf, // ok if undefined
    };
    ...
    <Box component="form" onSubmit={handleSubmit} noValidate>
      ...
      <Stack direction={{ xs: "column", md: "row" }} spacing={2} sx={{ mb: 2 }}>
        ...
        <TextField
          ...
          helperText="Max orders per day; leave blank for unlimited"
        />
      </Stack>
